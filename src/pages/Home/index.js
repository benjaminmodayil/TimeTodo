      ...
      <React.Fragment>
        <main className="bg-red py-16 md-py-0">
          <div className="container p-4 md-p-2 lg-p-0 text-white mx-auto md-h-screen">
            <div className="md-flex md-flex-col md-flex-row justify-between md--mx-8 lg--mx-16 items-center h-screen">
              <div className="flex flex-col mb-8 md-mb-0 md-w-1-2 md-px-8 lg-px-16 max-w-md">
